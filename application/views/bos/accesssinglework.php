...
<div class="container mt-5">
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-1"><a href="<?= base_url('bos/editassignment/' . $assignment['id']); ?>" class="btn btn-outline-primary"> Edit</a></div>
        <div class="col-lg-1"><a href="<?= base_url('bos/deleteassignment/' . $assignment['id']); ?>" class="btn btn-outline-danger" onclick="return confirm('Are You Sure ?');"> Delete</a></div>
    </div>
