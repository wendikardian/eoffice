...
<div class="container mt-5">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-1">
            <a href="<?= base_url('mailbox/send_draft/' . $mail['id']); ?>" onclick="return confirm('Are You Sure ?');" class="btn btn-primary"><i class="ni ni-send"></i></a>
        </div>
        <div class="col-lg-1">
            <a href="<?= base_url('mailbox/trash_sender/' . $mail['id']); ?>" onclick="return confirm('Are you Sure?');" class="btn btn-danger"><i class="fa fa-trash"></i></a>
        </div>
    </div>
    </form>
</div>