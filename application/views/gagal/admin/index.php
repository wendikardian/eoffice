          ...
          <div class="row">
                  ...
                  <div class="analytics-sparkle-line reso-mg-b-30">
                      <div class="analytics-content">
                          <?php
                            ...
                            ?>
                          <h5>Admin</h5>
                          <h2><span class="counter"><?= $admin; ?></span>
                          </h2>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                  <div class="analytics-sparkle-line reso-mg-b-30">
                      <div class="analytics-content">
                          <h5>Bos</h5>
                          <h2><span class="counter"><?= $bos; ?></span>
                          </h2>
                          <div class="progress m-b-0">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                  <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                      <div class="analytics-content">
                          <h5>Employee</h5>
                          <h2><span class="counter"><?= $employee; ?></span>
                          </h2>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                  <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                      <div class="analytics-content">
                          <h5>Guest</h5>
                          <h2><span class="counter"><?= $guest; ?></span>
                          </h2>
                          <div class="progress m-b-0">
                  ...
                  <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
                      ...
                      <ul class="list-inline two-part-sp">
                          ...
                          <li class="text-right graph-two-ctn"><i class="fa fa-level-up" aria-hidden="true"></i>
                              <span class="counter text-purple">3000</span></li>
                      </ul>
                  </div>
                  <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
          ...
          <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <div class="single-cards-item">
                      <div class="single-product-image">
                          <a href="#"><img src="<?= base_url('assets/admin/'); ?>img/product/profile-bg.jpg" alt=""></a>
                      </div>
                      <div class="single-product-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/product/pro4.jpg" alt="">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                      ...
                      <div class="single-review-st-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/notification/1.jpg" alt="">
                      ...
                      <div class="single-review-st-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/notification/2.jpg" alt="">
                          <div class="review-ctn-hf">
                              <h3>Garbease sha</h3>
                              <p>Awesome Pro</p>
                          </div>
                      ...
                      <div class="single-review-st-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/notification/4.jpg" alt="">
                          <div class="review-ctn-hf">
                              <h3>Siam Graves</h3>
                              <p>That's Good</p>
                          </div>
                      ...
                      <div class="single-review-st-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/notification/5.jpg" alt="">
                          <div class="review-ctn-hf">
                              <h3>Sarah Graves</h3>
                              <p>Highly recommend</p>
                          </div>
                      ...
                      <div class="single-review-st-text">
                          <img src="<?= base_url('assets/admin/'); ?>img/notification/6.jpg" alt="">
                          <div class="review-ctn-hf">
                              <h3>Julsha Grav</h3>
                              <p>Sei Hoise bro</p>
                          </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                      <div class="single-product-image">
                          <a href="#"><img src="<?= base_url('assets/admin/'); ?>img/product/book-4.jpg" alt=""></a>
                      </div>
                  ...
                  <div class="white-box res-mg-t-30 table-mg-t-pro-n">
                      ...
                      <ul class="country-state">
                          <li>
                              ...
                              <div class="progress">
                                  <div class="progress-bar progress-bar-danger ctn-vs-1" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:75%;">
                          ...
                          <li>
                              ...
                              <div class="progress">
                                  <div class="progress-bar progress-bar-info ctn-vs-2" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:48%;">
                          ...
                          <li>
                              ...
                              <div class="progress">
                                  <div class="progress-bar progress-bar-success ctn-vs-3" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:55%;">
                          ...
                          <li>
                              ...
                              <div class="progress">
                                  <div class="progress-bar progress-bar-success ctn-vs-4" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:33%;">
                          ...
                          <li>
                              ...
                              <div class="progress">
                                  <div class="progress-bar progress-bar-inverse ctn-vs-5" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:60%;">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                      <div class="courses-title">
                          <a href="#"><img src="<?= base_url('assets/admin/'); ?>img/courses/1.jpg" alt="" /></a>
