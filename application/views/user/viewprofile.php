<!-- Header -->
<!-- Header -->
<div class="header pb-6 d-flex align-items-center" style="min-height: 300px; background-image: url(<?= base_url('assets/img/profile/' . $profile['image']); ?>); background-size: cover; background-position: center top;">
    <!-- Mask -->
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-12 col-md-10">
                <h3 class="display-2 text-white">This is <?= $profile['name']; ?></h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card card-profile">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 order-lg-2">
                        <div class="card-profile-image">
                            <a href="#">
                                <img src="<?= base_url('assets/img/profile/' . $profile['image']); ?>" class="rounded-circle">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-center mt-5">
                        ...
                        <h5 class="h3">
                            <?= $profile['email']; ?><span class="font-weight-light"></span>
                        </h5>
                        <?php
                        ...
                        <div class="h5 mt-2">
                            <i class="ni business_briefcase-24 mr-2"></i><?= $profile['telp']; ?>
                        </div>
                        <div>
                            <i class="ni education_hat mr-2"></i> Member Since : <?= date('d F Y', $profile['date_created']); ?>
                        </div>
                        <?php if (($user['role_id'] == 2) and ($profile['role_id'] != 2)) : ?>
                            <div>
                                <hr class="mt--1">
                                <a href="<?= base_url('bos/addpoint_profile/' . $profile['id']); ?>"><button class="btn btn-success"> Add Some Point </button></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="<?= base_url('profile/point/' . $profile['id']); ?>">
