<div class="header pb-6 d-flex align-items-center" style="min-height: 300px; background-image: url(<?= base_url('assets/img/group/' . $group['image']); ?>); background-size: cover; background-position: center top;">
    <!-- Mask -->
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-12 col-md-10">
                <h1 class="display-2 text-white"> <?= $group['title']; ?></h1>
                <p class="text-white mt-0 mb-5">This is Change Group Password page.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card">
                <div class="card-header">
                    <form action="<?= base_url('dashboard/password_group/' . $id); ?>" method="post">
